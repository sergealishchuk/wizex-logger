...
VALUES
  (
    1,
    'RecoveryPassword_en',
    'Reset your password at ALIOKS.COM',
    'Hello, <b>{{username}}</b>!\n<br/><br />\nTo reset your password, you need to enter the code below in the appropriate form on <a href="{{url}}">alioks.com</a>\n<br /><br />\n<p>\n<span style="border: 1px gray solid; border-radius: 5px; font-size: 26px; color: green; padding: 8px;">{{code}}</span>\n</p>\n<br />\nSincerely and thank you,<br />\n<span style="color: #556cd6; font-size: 15px; font-weight: bold;">Alioks Team</span>\n<br />\n<a href="{{url}}">alioks.com</a>\n\n',
  ...
  (
    2,
    'RecoveryPassword_uk',
    'Скинути свій пароль на ALIOKS.COM',
    'Вітаємо, <b>{{username}}</b>!\n<br/><br />\nЩоб скинути пароль, вам необхідно ввести наведений нижче код у відповідну форму на <a href="{{url}}">alioks.com</a>\n<br /><br />\n<p>\n<span style="border: 1px gray solid; border-radius: 5px; font-size: 26px; color: green; padding: 8px;">{{code}}</span>\n</p>\n<br />\nЗ повагою,<br />\n<span style="color: #556cd6; font-size: 15px; font-weight: bold;">Alioks Team</span>\n<br />\n<a href="{{url}}">alioks.com</a>',
    '{\n  "username": "Jhon Benson",\n  "code": "AGMDBN",\n  "url": "http://localhost:3000"\n}',
    2
  ),
  (
    3,
    'Welcome_en',
    'Success registration on ALIOKS.COM',
    'Congratulations <b>{{username}}</b>!\n<br /><br />\n<div>You have successfully registered on Alioks.com. After authorization, you will be prompted to enter the code you see below. This is required to verify your email.</div>\n<br />\n<p>\n<span style="border: 1px gray solid; border-radius: 5px; font-size: 26px; color: green; padding: 8px;">{{code}}</span>\n</p>\n<br />\nSincerely and thank you,<br />\n<span style="color: #556cd6; font-size: 15px; font-weight: bold;">Alioks Team</span>\n<br />\n<a href="{{url}}">alioks.com</a>\n\n\n',
  ...
  (
    4,
    'Welcome_uk',
    'Успішна реєстрація на ALIOKS.COM',
    'Вітаємо <b>{{username}}</b>!\n<br /><br />\n<div>Ви успішно зареєструвалися на alioks.com. Після авторизації вам буде запропоновано ввести код, який ви бачите нижче. Це потрібно для підтвердження електронної пошти.</div>\n<br />\n<p>\n<span style="border: 1px gray solid; border-radius: 5px; font-size: 26px; color: green; padding: 8px;">{{code}}</span>\n</p>\n<br />\nЗ повагою,<br />\n<span style="color: #556cd6; font-size: 15px; font-weight: bold;">Alioks Team</span>\n<br />\n<a href="{{url}}">alioks.com</a>\n\n',
    '{\n  "username": "Jhon",\n  "code": "ASDFAS-23234-ASDF",\n  "url": "http://localhost:3000"\n}',
    4
  ),
  (
  ...
  (
    6,
    'ConfirmEmail_uk',
    'Підтвердіть свою електронну адресу | ALIOKS.COM',
    'Вітаємо, <b>{{username}}</b>!\n<br/><br />\nВи ввели цю електронну адресу на alioks.com\nЩоб підтвердити, що це ваш e-mail, введіть цей код підтвердження у відповідному запиті.\n<br /><br />\n<p>\n<span style="border: 1px gray solid; border-radius: 5px; font-size: 26px; color: green; padding: 8px;">{{code}}</span>\n</p>\n<br />\nЗ повагою,<br />\n<span style="color: #556cd6; font-size: 15px; font-weight: bold;">Alioks Team</span>\n<br />\n<a href="{{url}}">alioks.com</a>',
    '{\n  "username": "Jhon",\n  "code": "ASDFAS-23234-ASDF",\n  "url": "http://localhost:3000"\n}',
    6
  ),
  (
    ...
    'The password has been changed on ALIOKS.COM',
  ...
  (
    9,
    'EmailChanged_en',
    'Your account email address has been changed | ALIOKS.COM',
  ...
  (
    10,
    'EmailChanged_uk',
    'Адресу електронної пошти вашого облікового запису було змінено | ALIOKS.COM',
